...
static NSString * const kMyAPIKey = @"<API-KEY>";
...
- (void)startSharingAndScanning {
  ...
  NSString *messageJson = [NSString stringWithFormat:@"{\"mMessageBody\":\"%@\",\"mUUID\":\"123123123\"}", name];
  // Publish the name to nearby devices.
  GNSMessage *pubMessage =
      [GNSMessage messageWithContent:[messageJson dataUsingEncoding:NSUTF8StringEncoding]];
